...
#define DPI_DMA_PANICS_UPPER_COUNT_MASK		     (0x0000FFFF << DPI_DMA_PANICS_UPPER_COUNT_SHIFT)
#define DPI_DMA_PANICS_LOWER_COUNT_SHIFT	     16
#define DPI_DMA_PANICS_LOWER_COUNT_MASK		     (0x0000FFFF << DPI_DMA_PANICS_LOWER_COUNT_SHIFT)
...
#define IMASK_RGB(r, g, b)   (BITS(DPI_DMA_IMASK_R, r)  | BITS(DPI_DMA_IMASK_G, g)  |  BITS(DPI_DMA_IMASK_B, b))
#define OMASK_RGB(r, g, b)   (BITS(DPI_DMA_OMASK_R, r)  | BITS(DPI_DMA_OMASK_G, g)  |  BITS(DPI_DMA_OMASK_B, b))
#define ISHIFT_RGB(r, g, b)  (BITS(DPI_DMA_SHIFT_IR, r) | BITS(DPI_DMA_SHIFT_IG, g) |  BITS(DPI_DMA_SHIFT_IB, b))
#define OSHIFT_RGB(r, g, b)  (BITS(DPI_DMA_SHIFT_OR, r) | BITS(DPI_DMA_SHIFT_OG, g) |  BITS(DPI_DMA_SHIFT_OB, b))
