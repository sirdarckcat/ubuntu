...
{
	static const char * const names[] = { "NONE", "F132", "F528", "UNKNOWN" };
...
{
	static struct mbdb_op_csr_range port_show_csr_ranges[] = {
	...
	if (ops_port_status_get(sd, lpn, ARRAY_SIZE(port_show_csr_ranges), port_show_csr_ranges,
				&rsp->port_status_op))
		return -EINVAL;
