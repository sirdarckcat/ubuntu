...
#define   PVC_BLITTER_SCHEDULING_MODE_MASK	REG_GENMASK(12, 11)
#define   PVC_BLITTER_ROUND_ROBIN_MODE		REG_FIELD_PREP(PVC_BLITTER_SCHEDULING_MODE_MASK, 0x1)
...
#define   RING_FORCE_TO_NONPRIV_DENY		REG_BIT(30) /* gen12+ */
