...
#define INTEL_GUC_FIRMWARE_DEFS(fw_def, guc_def) \
	...
	fw_def(DG1,          0, guc_def(dg1,  70, 0, 7)) \
	fw_def(ROCKETLAKE,   0, guc_def(tgl,  70, 0, 7)) \
	fw_def(TIGERLAKE,    0, guc_def(tgl,  70, 0, 7)) \
	fw_def(JASPERLAKE,   0, guc_def(ehl,  70, 0, 7)) \
	fw_def(ELKHARTLAKE,  0, guc_def(ehl,  70, 0, 7)) \
	fw_def(ICELAKE,      0, guc_def(icl,  70, 0, 7)) \
	fw_def(COMETLAKE,    5, guc_def(cml,  70, 0, 7)) \
	fw_def(COMETLAKE,    0, guc_def(kbl,  70, 0, 7)) \
	fw_def(COFFEELAKE,   0, guc_def(kbl,  70, 0, 7)) \
	fw_def(GEMINILAKE,   0, guc_def(glk,  70, 0, 7)) \
	fw_def(KABYLAKE,     0, guc_def(kbl,  70, 0, 7)) \
	fw_def(BROXTON,      0, guc_def(bxt,  70, 0, 7)) \
	fw_def(SKYLAKE,      0, guc_def(skl,  70, 0, 7))
