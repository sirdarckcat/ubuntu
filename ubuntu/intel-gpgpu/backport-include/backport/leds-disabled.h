...
#define led_classdev LINUX_I915_BACKPORT(led_classdev)
#define led_trigger LINUX_I915_BACKPORT(led_trigger)
...
#define led_classdev_register LINUX_I915_BACKPORT(led_classdev_register)
#undef led_classdev_unregister
#define led_classdev_unregister LINUX_I915_BACKPORT(led_classdev_unregister)
#undef led_blink_set
#define led_blink_set LINUX_I915_BACKPORT(led_blink_set)
#undef led_set_brightness
#define led_set_brightness LINUX_I915_BACKPORT(led_set_brightness)
#undef led_classdev_suspend
#define led_classdev_suspend LINUX_I915_BACKPORT(led_classdev_suspend)
#undef led_classdev_resume
#define led_classdev_resume LINUX_I915_BACKPORT(led_classdev_resume)

#undef led_trigger_register
#define led_trigger_register LINUX_I915_BACKPORT(led_trigger_register)
#undef led_trigger_unregister
#define led_trigger_unregister LINUX_I915_BACKPORT(led_trigger_unregister)
#undef led_trigger_register_simple
#define led_trigger_register_simple LINUX_I915_BACKPORT(led_trigger_register_simple)
#undef led_trigger_unregister_simple
#define led_trigger_unregister_simple LINUX_I915_BACKPORT(led_trigger_unregister_simple)
#undef led_trigger_event
#define led_trigger_event LINUX_I915_BACKPORT(led_trigger_event)
