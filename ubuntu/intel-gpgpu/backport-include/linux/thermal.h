...
#define thermal_zone_device_ops LINUX_I915_BACKPORT(thermal_zone_device_ops)
...
#define thermal_zone_device_register \
	LINUX_I915_BACKPORT(thermal_zone_device_register)
...
#define thermal_zone_device_unregister			\
	LINUX_I915_BACKPORT(thermal_zone_device_unregister)
