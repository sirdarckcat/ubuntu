...
#define __pskb_copy LINUX_I915_BACKPORT(__pskb_copy)
extern struct sk_buff *__pskb_copy(struct sk_buff *skb,
				   int headroom, gfp_t gfp_mask);

#define skb_complete_wifi_ack LINUX_I915_BACKPORT(skb_complete_wifi_ack)
...
#define skb_frag_page LINUX_I915_BACKPORT(skb_frag_page)
static inline struct page *skb_frag_page(const skb_frag_t *frag)
{
	return frag->page;
}

#define skb_frag_size LINUX_I915_BACKPORT(skb_frag_size)
...
#define skb_frag_dma_map LINUX_I915_BACKPORT(skb_frag_dma_map)
...
#if LINUX_VERSION_IS_LESS(3,2,0)
#define skb_frag_size_sub LINUX_I915_BACKPORT(skb_frag_size_sub)
 ...
 * be mapped.
 */
#define skb_frag_address LINUX_I915_BACKPORT(skb_frag_address)
...
#if LINUX_VERSION_IS_LESS(3,9,0)
#define skb_unclone LINUX_I915_BACKPORT(skb_unclone)
...
#define skb_frag_address_safe LINUX_I915_BACKPORT(skb_frag_address_safe)
/**
...
#define __pskb_copy_fclone LINUX_I915_BACKPORT(__pskb_copy_fclone)
...
#define skb_clone_sk LINUX_I915_BACKPORT(skb_clone_sk)
...
*/
#define __dev_alloc_pages LINUX_I915_BACKPORT(__dev_alloc_pages)
...
#define dev_alloc_pages LINUX_I915_BACKPORT(dev_alloc_pages)
 ...
 * %NULL is returned if there is no free memory.
 */
#define __dev_alloc_page LINUX_I915_BACKPORT(__dev_alloc_page)
static inline struct page *__dev_alloc_page(gfp_t gfp_mask)
{
	return __dev_alloc_pages(gfp_mask, 0);
}

#define dev_alloc_page LINUX_I915_BACKPORT(dev_alloc_page)
...
#if LINUX_VERSION_IS_LESS(3,19,0)
#define skb_copy_datagram_msg LINUX_I915_BACKPORT(skb_copy_datagram_msg)
...
#define memcpy_from_msg LINUX_I915_BACKPORT(memcpy_from_msg)
 ...
 */
#define skb_put_padto LINUX_I915_BACKPORT(skb_put_padto)
...
#define skb_ensure_writable LINUX_I915_BACKPORT(skb_ensure_writable)
...
#define skb_mac_offset LINUX_I915_BACKPORT(skb_mac_offset)
 ...
 */
#define skb_frag_off LINUX_I915_BACKPORT(skb_frag_off)
