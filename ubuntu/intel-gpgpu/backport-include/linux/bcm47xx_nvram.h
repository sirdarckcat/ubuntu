...
#define bcm47xx_nvram_get_contents LINUX_I915_BACKPORT(bcm47xx_nvram_get_contents)
static inline char *bcm47xx_nvram_get_contents(size_t *val_len)
{
	return NULL;
}

#define bcm47xx_nvram_release_contents LINUX_I915_BACKPORT(bcm47xx_nvram_release_contents)
