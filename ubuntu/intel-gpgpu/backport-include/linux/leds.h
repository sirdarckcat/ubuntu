...
/*
 * There is no LINUX_I915_BACKPORT() guard here because we want it to point to
...
#define led_set_brightness_sync LINUX_I915_BACKPORT(led_set_brightness_sync)
/**
...
#if LINUX_VERSION_IS_LESS(4,5,0)
#define devm_led_trigger_register LINUX_I915_BACKPORT(devm_led_trigger_register)
